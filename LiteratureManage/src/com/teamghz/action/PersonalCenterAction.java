...
public class PersonalCenterAction {
	...
	public void getShareInfo() {
		...
		String sql = "select Article.articlename, Article.url, Article.articleid, Article.comment, User.username, Share.time, Share.feeling, User.userid, User.avatar from User, Article, Share  WHERE User.userid=Share.userid and Share.articleid=Article.articleid ORDER BY Share.id";

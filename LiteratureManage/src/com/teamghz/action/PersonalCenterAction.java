...
public class PersonalCenterAction {
	...
	public void getShareInfo() {
		...
		String sql = "select Article.articlename, Article.url, Article.articleid, Article.comment, User.username, Share.time, Share.feeling from User, Article, Share  WHERE Share.userid=User.userid and Share.articleid=Article.articleid";
